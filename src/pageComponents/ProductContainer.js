...
function ProductContainer({productList}) {
  return (
    <>
      <div className="flex flex-nowrap overflow-x-scroll gold-collection-container vsm:overflow-x-hidden pb-[40px] vsm:grid vsm:grid-cols-12 gap-y-[60px] gap-[28px] mt-[50px] vsm:mt-[80px] w-[100%]" data-aos="fade-up" data-aos-duration="1500">
            {/* <!-- card-container --> */}
