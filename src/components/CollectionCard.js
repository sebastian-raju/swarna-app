...
function CollectionCard({product}) {
  ...
  return (
    <>
      <div className="col-span-12 vsm:col-span-6 md:col-span-4 lg:col-span-3 flex flex-col items-start collection-card relative" data-aos="zoom-in" data-aos-duration="1000">
        <img src={image} className="h-[350px] w-[100%] object-cover" alt=""/>
